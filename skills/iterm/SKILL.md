...
description: >-
  ...
  Only use this skill when the user explicitly asks: "set tab", "color tab",
  "label tab", "iterm", or "tag this". Never trigger proactively.
---
...
| `infra`   | Warm amber    | 190, 120, 50  | Infrastructure, Docker, CI/CD, deployment      |
...
Examples:
```bash
~/.claude/scripts/iterm-tab.sh pickup "PIC - KB Migration"
~/.claude/scripts/iterm-tab.sh feature "Feature - Meeting Notes Pipeline"
~/.claude/scripts/iterm-tab.sh infra "Infra - SSL Renewal"
~/.claude/scripts/iterm-tab.sh bug "Bug - Auth Loop"
